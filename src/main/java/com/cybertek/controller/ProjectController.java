...
public class ProjectController {
    ...
    @DefaultExceptionMessage(defaultMessage = "Something went wrong, try again!")
    @PreAuthorize("hasAnyAuthority('Admin','Manager')")
    public ResponseEntity<ResponseWrapper> readByProjectCode(@PathVariable("**projectcode**") String code){
    ...
    @Operation(summary = "Read all non completed projects")
    @DefaultExceptionMessage(defaultMessage = "Something went wrong, try again!")
    @PreAuthorize("hasAnyAuthority('Employee','Manager')")
    public ResponseEntity<ResponseWrapper> readAllNonCompletedProjects() {
        List<ProjectDTO> projectDTOs = projectService.listAllNonCompletedProjects();
        return ResponseEntity.ok(new ResponseWrapper("Projects are retrieved with details",projectDTOs));
    }
}
